    ...
    <form id="form1" runat="server">
        <div>
            <table>
				...
				<tr>
					<td>Day off:<br/><small>08/05/08-08/20/08</small></td>
					<td>
						...
						<asp:RangeValidator runat="server" ID="ValidateDayOff2" 
                            ControlToValidate="DayOff" MinimumValue="05/08/2008"
							MaximumValue="20/08/2008" Type="Date" 
                            ErrorMessage="Day Off is not within the valid interval" Display="dynamic" SetFocusOnError="True">*
    			        </asp:RangeValidator>
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<asp:CompareValidator runat="server" ID="ValidateAge" 
                            ControlToValidate="Age" ValueToCompare="18" Type="Integer"
				...
				<tr>
					...
					<td>
						...
						<asp:CompareValidator runat="server" 
                            ...
                            ControlToCompare="Password" Type="String"
							ErrorMessage="The passwords don't match" Display="dynamic" 
                            ID="Comparevalidator1" Name="Comparevalidator1">
