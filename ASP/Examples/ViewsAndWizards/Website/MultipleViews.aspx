...
<body>
    ...
    <div>
        <asp:DropDownList ID="DropDownList1" runat="server" Width="235px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>
        <hr />
        <br />
